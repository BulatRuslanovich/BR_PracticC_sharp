...
namespace KeyShop.Migrations {
    ...
    [Migration("20231103105954_AddProfileImageAndGameList")]
    partial class AddProfileImageAndGameList {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KeyShop.Models.Game", b => {
                ...
                b.Property<string>("Developer").HasColumnType("text");

                b.Property<int>("Genre").HasColumnType("integer");

                b.Property<List<string>>("Images").HasColumnType("text[]");

                b.Property<int>("Platform").HasColumnType("integer");

                b.Property<decimal>("Price").HasColumnType("numeric");

                b.Property<string>("Publisher").HasColumnType("text");
            ...
            modelBuilder.Entity("KeyShop.Models.User", b => {
                b.Property<string>("Id").HasColumnType("text");

                b.Property<int>("AccessFailedCount").HasColumnType("integer");

                b.Property<double?>("Balance").HasColumnType("double precision");
                ...
                b.Property<List<string>>("GameIdList").HasColumnType("text[]");
            ...
            modelBuilder.Entity("KeyShop.Models.Game", b => {
                b.HasOne("KeyShop.Models.User", "User").WithMany().HasForeignKey("UserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b => {
                b.HasOne("KeyShop.Models.User", null)
                    .WithMany()
